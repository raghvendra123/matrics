...
class UserAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkFieldAccess($operation, FieldDefinitionInterface $field_definition, AccountInterface $account, FieldItemListInterface $items = NULL) {
    ...
    switch ($field_definition->getName()) {
      ...
      case 'roles':
        // Allow viewing the roles, but not editing it.
        return $is_own_account && $account->hasPermission('view own account details') ? AccessResult::allowed()
          ->cachePerUser() : AccessResult::neutral();
