...
/**
 * Provides a Update Image Resource.
 *
 * @RestResource(
 *   id = "update_image",
 *   label = @Translation("Update Profile Image"),
 *   serialization_class = "Drupal\file\Entity\File",
 *   uri_paths = {
 *     "create" = "/update_image/{entity_type_id}/{bundle}/{field_name}"
 *   }
 * )
 */
class UpdateImageResource extends ResourceBase {
  ...
  public function post(Request $request, $entity_type_id, $bundle, $field_name) {
    ...
    $user->save();
    return new ModifiedResourceResponse(['message' => 'Upload image Successfully'], 200);
  }
